...
можно выделить 4 переменных (`A`, `B`, `C`, `D`) типа `double`.
...
2. **Сравнение чисел:**  
   Программа сравнивает значения `A`, `B`, `C`, `D`. В конечном итоге выводит нужное (третье по величине).
